...
import { ProductLine, Product } from "@/types/products";
...
export default function ProductLineDetail({ productLine, productLineSlug }: ProductLineDetailProps) {
